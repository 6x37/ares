...
class RuntimeSettings(BaseSettings):
    ...
    image: str = Field(
        # Arès default: locally re-tagged sandbox image (Apache-2.0 §4: changed).
        # Falls back to pulling the upstream image if ares-sandbox isn't present.
        default="ares-sandbox:1.3.0",
        validation_alias=AliasChoices("ARES_IMAGE", "STRIX_IMAGE"),
    )
