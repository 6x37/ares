...
async def warm_up_llm(show_model_warning: bool = True) -> None:
    ...
    try:
        ...
        if raw_model:
            logger.info("Ares engine model: %s", raw_model)
        ethics = Text()
        ethics.append("ARES - ETHICAL USE ONLY", style="bold red")
        ethics.append("\n\n", style="white")
        ethics.append(
            "Ares is an autonomous offensive-security tool for AUTHORIZED testing "
            ...
            "responsible for how you use Ares.\n"
